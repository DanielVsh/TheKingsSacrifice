...
import GameAnalysis from "@/pages";
import Play from "@/pages/play.tsx";
import GameDatabase from "@/pages/database.tsx";

export const appRoutes: AppRoute[] = [
  { path: "/", element: <MainPage />, breadcrumb: "Home" },
  { path: "/analysis", element: <GameAnalysis/>, breadcrumb: "Analysis" },
  { path: "/database", element: <GameDatabase/>, breadcrumb: "Database" },
  // { path: "/play/bot", element: <BotSelectPage />, breadcrumb: "Practice"},
  { path: "/play/bot", element: <Play />, breadcrumb: "Practice"},
